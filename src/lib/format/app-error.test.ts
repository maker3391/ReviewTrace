...
describe("⑪ HTTP Status 는 오류 의미를 따른다", () => {
  ...
  it("의미별 등급이 지금 그대로다", () => {
    const expected: Record<string, number> = {
      ...
      AGENT_CAPABILITY_REQUIRED: 403,
      AGENT_CONTEXT_REQUIRED: 400,
      AGENT_CREDENTIAL_NAME_INVALID: 400,
      NOT_CONNECTED_OR_NOT_AUTHORIZED: 404,
      REPOSITORY_CONTEXT_AMBIGUOUS: 409,
