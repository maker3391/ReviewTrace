 ...
 * 이유로 여기 둔다. Knowledge 의 업무 의미를 하나도 갖지 않는다: 받는 것은
...
/** 이 Component 가 그리는 낱말. 🔴 사전 전체를 넘기지 않는다. */
 ...
 *. 미리 보기(`MarkdownView`)도 **같은 세 변수**를 쓴다 — 한 문서의 편집
 ...
 */
 ...
 「한 색」으로 돌아오고, package.json 에 여섯 줄이 는다.
 */
 ...
 */
 ...
 <div
 className={cn(
 // 편집기는 «덩어리»로 읽혀야 하는 것이라 올라온 표면에 둔다.
