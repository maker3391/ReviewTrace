...
export const ko = {
  ...
  invite: {
    ...
    signInFirst:
      "먼저 GitHub으로 로그인하세요. 로그인하면 이 화면으로 돌아옵니다.",
    accept: "초대 수락",
  },
  ...
  validation: {
    ...
    rules: {
      ...
      endLineWithoutStartLine:
        "끝 줄 번호를 보내려면 시작 줄 번호도 함께 보내야 합니다.",
  ...
  errors: {
    ...
    AGENT_BODY_UNSTORABLE_TEXT:
      "요청 본문에 저장할 수 없는 문자가 들어 있습니다.",
    AGENT_IDEMPOTENCY_KEY_TOO_LONG: "Idempotency-Key가 너무 깁니다.",
    ...
    PERSONAL_WORKSPACE_UNDELETABLE: "개인 워크스페이스는 삭제할 수 없습니다.",
